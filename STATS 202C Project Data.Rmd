...
points(sampling$X1,sampling$X2,col="blue",pch=16)
points(sampling$X1[which.min(sampling$Value)],
       sampling$X2[which.min(sampling$Value)],col="red",pch="1")
points(0.82,0.97,col="red",pch="2")
points(0.90,0.69,col="red",pch="3")
points(0.50,0.72,col="red",pch="4")
points(0.73,0.60,col="red",pch="5")
points(0.78,0.82,col="red",pch="6") 
```
